...
// --------------------- SCHEMAS ---------------------
// const QuestionSchema = new mongoose.Schema({ ------->questions/route.js (1)
//   id: String,
//   type: String,
//   primaryTrait: String,
//   text: String,
...
// const LikertAnswerSchema = new mongoose.Schema({ ------> saveResponses/route.js (1)
//   questionId: String,
//   responseText: String,
...
// const createLikertAnswers = (baseSkills, reverse = false) => { ------> questions/route.js (2)
...
// app.get("/api/ping", (req, res) => { ---->ping/route.js
//   res.send("✅ Backend is alive");
// });

// app.post("/api/add-questions", async (req, res) => { ------->add-questions/route.js
//   try {
...
// app.get("/api/questions", async (req, res) => { ----->questions/route.js (3)
//   try {
...
// app.get("/api/candidates", async (req, res) => { ----> candidates/route.js
//   try {
...
// app.post("/api/saveResponses", async (req, res) => { ----->saveResponses/route.js (2)
//   try {
...
// app.get("/api/get-responses", async (req, res) => { ----->get-responses/route.js
//   try {
