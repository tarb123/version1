...
type Props = {
  ...
  responses: Responses;
  traitKey?: string;
  leftLabel?: string;  // Reserved
  rightLabel?: string; // Outgoing
};
...
export default function ReservedOutgoingScore({
  questions,
  responses,
  traitKey = "Reserved vs Outgoing",
  leftLabel = "Reserved",
  rightLabel = "Outgoing",
}: Props) {
