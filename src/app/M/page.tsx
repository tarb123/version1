...
//   const [checkData, setCheckData] = useState<any>(null); // type later
...
//     return maxScores;
//   }, [skillList,calculateMaxSkillScore]
// );
...
//     let traitScoreSum = 0; let traitWeightSum = 0;
...
//           <div className="mt-2 text-xs font-sans serif ">
//             {questions.map((question, index) =>
//               index === currentIndex ? (
//                 <QuestionBlock key={question.id} questionData={question} questionIndex={index}
//                   selectedAnswerValue={selectedAnswers[question.id]} onAnswerChange={handleAnswerChange}
//                 />
//               ) : null
//             )}
//           </div>
...
//         ...prev, "INFO-NAME": checkData.candidate.name, "INFO-EMAIL": checkData.candidate.email, "INFO-AGE": checkData.candidate.age,
//        }));
...
//         onCancel={() => {
//           setSelectedAnswers((prev: any) => ({
//             ...prev, "INFO-NAME": "", "INFO-EMAIL": "", "INFO-AGE": "",
//           }));
//           setShowAlert(false);
// }}
